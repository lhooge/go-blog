...
//MySQLTokenDatasource providing an implementation of TokenDatasourceService using MariaDB
type MySQLTokenDatasource struct {
	SQLConn *sql.DB
}

//Create creates a new token
func (rdb MySQLTokenDatasource) Create(t *Token) (int, error) {
...
func (rdb MySQLTokenDatasource) Get(hash string, tt TokenType) (*Token, error) {
	var t Token
	var u User
...
func (rdb MySQLTokenDatasource) Remove(hash string, tt TokenType) error {
